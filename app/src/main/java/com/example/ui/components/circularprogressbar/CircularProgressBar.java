package com.example.ui.components.circularprogressbar;
...
public class CircularProgressBar extends View {
    ...
    private static final boolean DEFAULT_RIGHT_TO_LEFT = true;
    ...
    private boolean rightToLeft = DEFAULT_RIGHT_TO_LEFT;
    private boolean indeterminateMode = false;
    private boolean clockwiseRotationMode = true;
    private boolean cornerRound = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            clockwiseRotationMode = typedArray.getBoolean(R.styleable.CircularProgressBar_cpb_clockwise_rotation_mode, clockwiseRotationMode);
            cornerRound = typedArray.getBoolean(R.styleable.CircularProgressBar_cpb_corner_round, cornerRound);
        } finally {
            typedArray.recycle();
        }
        ...
        foregroundPaint.setStrokeCap(cornerRound ? Paint.Cap.ROUND : Paint.Cap.BUTT);
    }
    //endregion
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int k = clockwiseRotationMode ? -1 : 1;
        canvas.drawArc(rectF, k*startAngle, k*angle, false, foregroundPaint);
    }
    ...
    public boolean isClockwiseRotationMode() {
        return clockwiseRotationMode;
    }

    public void setClockwiseRotationMode(boolean clockwiseRotationMode) {
        this.clockwiseRotationMode = clockwiseRotationMode;
    }
